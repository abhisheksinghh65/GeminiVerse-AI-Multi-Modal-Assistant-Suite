...
from gemini_utility import (load_gemini_flash_model,
...
# Function to translate roles between Gemini-1.5-Flash and Streamlit terminology
...
if selected == "Image Captioning":
    ...
    if st.button("Generate Caption"):
        ...
        # Get the caption of the image from the gemini-flash-vision LLM
